...
export function startAmbient() {
  ...
  whisper.start(); bell.start(); bellMod.start();

  // Very slow fade in — 6 seconds
  master.gain.linearRampToValueAtTime(1, c.currentTime + 6);

  ambientNodes = { master, sub1, sub2, drone, lfo, lfo2, whisper, bell, bellMod, droneFlt, revSend, subG, droneG, whG, bellG, whFlt, bellFlt, bellModG, lfoG, lfo2G };
}
